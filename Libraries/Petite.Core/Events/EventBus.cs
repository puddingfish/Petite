...
//        Filename :EventBus 
//        Description :    
//        Created by Wsy at 2016/7/5 11:29:53
...
using Petite.Core.Events.Factories.Internals;
using Petite.Core.Events.Handlers;
using Petite.Core.Events.Handlers.internals;
...
namespace Petite.Core.Events
{
    public class EventBus:IEventBus
    {
        ...
        /// <summary>
        /// 新建 <see cref="EventBus"/> 实例
        /// 如果不创建新实例,你可以使用 <see cref="Default"/> <see cref="EventBus"/>.Default全局实例
        /// </summary>
        public EventBus()
        {
